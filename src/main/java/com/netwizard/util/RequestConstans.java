...
public class RequestConstans {
	...
	public static Map<String, Object> imagesUtils(HttpServletRequest req)
	{
		...
		/*
		String logoUrl = "http://" + applicationPath + Images.LOGO_IMAGE;
		String loginUrl = "http://" + applicationPath ;
		String footerImageurl = "http://" + applicationPath +Images.FOOTER_IMAGE_URL;
		String bell_IconImageurl = "http://" + applicationPath 	+ Images.BELL_ICON_IMAGE_URL;
		String login_nw_btnImageurl = "http://" + applicationPath + Images.LOGIN_NW_BTN_IMAGE_URL;
		
		String care_heros_logoImageurl = "http://" + applicationPath + "/resources/images/care_heros_logo.png";
		String heart_iconImageurl = "http://" + applicationPath + "/resources/images/heart_icon.png";
		String need_care_iconImageurl = "http://" + applicationPath + "/resources/images/need_care_icon.png";
		String waiting_iconImageurl = "http://" + applicationPath 	+ "/resources/images/waiting_icon.png";
		*/
