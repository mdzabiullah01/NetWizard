...
<section id="main-content">
    ...
    <div class="row breadcrumb">
        <div class="col-md-6"><h1>Preferences</h1></div>
		...
		<div class="agileits-stats">
                    ...
                    <div class="row">
                        <div class="col-md-12"><h5>Define the group and department of Employees</h5></div>                        
                    </div>
                    ...
                    <div class="row topForm row-no-margin">
						...
						<div class="stats-last-agile">
							...
							<table id="prefer1Table" class="tableResponsiveData table stats-table responsive display nowrap tableResponsive">
								<thead>
									<tr>
										<th>S.No.</th>
										<th>Date</th>
                ...
                <div class="agileits-stats">
                    ...
                    <div class="col-md-12 stats-info stats-last widget-shadow">
                    <div class="row">
                        <div class="col-md-6"><h5>Employee Registration</h5></div>
                        <div class="col-md-6 text-right"><h6>For Bulk Registration, please <span class="linkText">click here</span></h6></div>
                    </div>
                    
                        <div class="stats-last-agile">
                        
                            <table id="prefer2Table" class="tableResponsiveData table stats-table responsive display nowrap tableResponsive">
                                <thead>
                                    <tr>
                                        <th>S.No.</th>
                                        <th>First Name</th>                                       
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center"><span class="saveIcon"></span>
                                        <span class="editIcon"></span></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td>Syed Sameer</td>
                ...
                <div class="agileits-stats">
                    ...
                    <div class="row">
                        ...
                        <div class="stats-last-agile">
                            ...
                            <table id="prefer3Table" class="tableResponsiveData table stats-table responsive display nowrap tableResponsive">
                                <thead>
                                    <tr>
                                        <th>S.No.</th>
                                        <th>Method</th>                                       
